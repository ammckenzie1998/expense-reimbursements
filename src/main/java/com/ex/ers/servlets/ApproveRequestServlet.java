...
/**
 * Servlet to handle reimbursement request approval responses and requests
 */
public class ApproveRequestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(user!=null){
            ...
            request.setStatus(RequestStatus.APPROVED.toString());
            dao.update(request);

            RequestHistory history = new RequestHistory();
            history.setUser(user);
            history.setDescription("Approved Reimbursement Request");
            history.setStatus(RequestStatus.APPROVED.toString());
